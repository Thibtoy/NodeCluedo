...
// import {nextTurn} from '../method/nextTurn.js';
// import {action} from '../method/action.js';
// import {createPopUpList} from '../method/createPopUpList.js';
// import {choice} from '../method/choice.js';
// import {select} from '../method/select.js';
// import {verifySuspicion} from '../method/verifySuspicion.js';

class Method {
	constructor(that) {
		// this.action = action.bind(that);
		// this.cardDistribution = cardDistribution.bind(that);
		// this.createPopUpList = createPopUpList.bind(that);
		...
		// this.nextTurn = nextTurn.bind(that);
		...
		// this.turnMethod = {
		// 	throwDices: throwDices.bind(that),
		// 	startTurn: startTurn.bind(that),
		// 	mouve: mouve.bind(that),
		// 	choice: choice.bind(that),
		// 	select: select.bind(that),
		// 	verifySuspicion: verifySuspicion.bind(that),
		// }
	}		
}
